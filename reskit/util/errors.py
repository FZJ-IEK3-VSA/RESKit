...
class RESKitDeprecationError(Exception):
    ...
    def __init__(self, commit_url):
        ...
        commit_url : str
            The url to the commit on github with the last working version
        ...
        message = f"'{calling_function_name}' is deprecated and should not be used anymore. Check out the last working version to reproduce results under: {commit_url}"
