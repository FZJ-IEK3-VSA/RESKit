...
def air_cooling_wenzel2025(placements, era5_path, temperatureCoolant, designTemperature, heatTransferDelta=5, efficiencyFan=0.7, pressureDropAir=261, efficiencyPump=0.7, pressureDropWater=200000,  output_netcdf_path = None, output_variables=None):
    ...
    wf.calculate_fan_power(temperatureCoolant, heatTransferDelta=heatTransferDelta, efficiencyFan=efficiencyFan, pressureDropAir=pressureDropAir, designTemperature=None)
    wf.calculate_pump_power(temperatureCoolant, heatTransferDelta=heatTransferDelta, efficiencyPump=efficiencyPump, pressureDropWater=pressureDropWater, designTemperature=None)
    wf.calculate_capacity_factor(designTemperature, temperatureCoolant, heatTransferDelta=heatTransferDelta, efficiencyFan=efficiencyFan, efficiencyPump=efficiencyPump, pressureDropAir=pressureDropAir, pressureDropWater=pressureDropWater)
