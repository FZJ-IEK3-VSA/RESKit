...
def roughness_from_clc(clc_path, loc, window_range=0):
    ...
    loc : Anything acceptable to geokit.LocationSet
        ...
        Agmunments accepted include: str, OGR point object (must have an SRS whitin the object, default = 4326 (for Europe)), lat and lon coordinates tuple (lat,lon).
        Referer to https://github.com/FZJ-IEK3-VSA/geokit/blob/master/geokit/core/location.py for more information.
...
############################################################################
# Defined primarily from [2] DTU Wind Energy. (2019). Gloabal Wind Atlas
...
def roughness_from_land_cover_classification(classification, land_cover_type='clc'):
    ...
    land_cover_type : str, optional
        ...
        'globCover': Gloabal Wind Atlas roughness lengths values
        'modis': Modis number for "no data" points of Gloabal Wind Atlas (mostly in areas North of 60°)
