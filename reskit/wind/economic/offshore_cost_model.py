...
def offshore_bos(
    ...
    mooringCostRate = (
        721  # dollars/tonne -- 0.12m diameter is chosen since it is the median in [1]
    )
    ...
    numberofTurbinesperPartialString = (
        0  # np.round(np.remainder((turbine_count*cp) , singleStringPower2))
    )
