...
2. The next example deals with wind power curves.
   1. First, [it shows](../../examples/3_wind/3_2_1_wind_load_power_curve.ipynb) how to define, load, and inspect a power curve.
   2. Then, [it is presented](../../examples/3_wind/3_2_1_wind_load_power_curve.ipynb) how the power curve changes depending on the capacity, rotor diameter, specific power, and cutout of the wind power plant.
