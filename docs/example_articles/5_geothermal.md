...
For Geothermal Energy Supply RESKit provides the simulation workflow presented in this [ xample](../../examples/4_solar/5_run_geothermal_simulations.ipynb). The workflow used is based on:
